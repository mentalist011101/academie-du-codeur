<div style="width:100%;position:fixed;height:5.5svh;display:flex;justify-content:center;align-items:center;z-index:4;align-items:balseline;font-weight: bold;justify-content:center;top:96svh;background:#005082;color:white"><marquee behavior="" direction="">académie du codeur</marquee></div>
    ...
    <div id="content">
        ...
        <div id="navigation">
            <nav id="bar_nav">
                ...
                <a href="../contact/" target="_parent" rel="noopener noreferrer" class="lien_page"><button>contacts</button></a>|
    ...
    <script>
        ...
        document.addEventListener("click",function ouverture(e) {
            ...
            if(lien=="/" || lien=="/services/" || lien=="/propos/" || lien=="/contact/" || lien=="/blog/"){
                window.open("/site_vitrine"+lien,"_parent","");
            }
        });
    </script>
    <?php
